...
public class BasePreviousWorkActivity extends BaseActivity {
	
	private static String TAG = "Zorz";
	private ListView listProjs;
	protected ProjectsListAdapter projsAdapter;
    protected ProjectsResponse projectsCache;
    protected boolean bShowFavoritesOnly;
    protected int lastCriteriaSelected = 0;
    protected String projectType = "android";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        projsAdapter = new ProjectsListAdapter(BasePreviousWorkActivity.this, new ArrayList<ProjectItem>());
    ...
    private void recreateListConditions(){
        ...
        if (bShowFavoritesOnly)
            projsAdapter.setProjectsList(FavoriteHandler.getFavorites(this, projectType).projects);
        else{
