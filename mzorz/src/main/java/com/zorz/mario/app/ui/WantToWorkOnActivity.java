...
public class WantToWorkOnActivity extends BaseActivity {
	...
	protected void onStart() {
        ...
        Service.getInstance().getThingsIWantToWorkOn();
	}
    ...
    public void onEvent(Event.WantToWorkLoadStartEvent event) {
        showProgressDialog(getString(R.string.server_login), false);
    }

    public void onEvent(Event.WantToWorkLoadCompleteEvent event) {
    ...
    public void onEvent(Event.WantToWorkLoadFailEvent event) {
        dismissProgressDialog();
        showError();
    }
